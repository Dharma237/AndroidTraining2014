...
import com.pcs.dialogprogressexample.DialogProgressActivity;
...
public class CustomAdapter extends BaseAdapter{
	...
	public CustomAdapter(DialogProgressActivity dialogClassActivity,
	...
	public View getView(int position, View convertView,ViewGroup parent) {
		...
		holder.dateTxt.setText("Date Of Birth:-"+userdetails.getDatePicker());
		holder.timeTxt.setText("BirthTime:-"+userdetails.getTimePicker());
